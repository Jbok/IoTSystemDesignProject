...
async def handle_action(websocket, message):
    ...
    elif action['name'] == "setText":
        print(action)
        print(action['parameters']['text'].encode('utf-8'))
        sirenPath = './siren.mp3'
        tmpPlayPath = './tmp.mp3'
        client_id = "ic7rjrzzz7"
        client_secret = "i5e1umbBhcenJanMrQ3a73gyjy5acrkFXrJnwofH"
        encText = urllib.parse.quote(action['parameters']['text'].encode('utf-8'))
...
project=asyncio.get_event_loop()
try:
